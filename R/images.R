...
#'
#' @param endpoint the DALL-E API endpoint to use. Default is "images/generations".
...
#' @param api_base the url of the DALL-E API server. Optional.
...
#' @export
create_image <- function(endpoint = "images/generations",
                         prompt,
                         n = 1,
...
#'
#' @param endpoint endpoint for API request (default: "images/edits")
...
#' @param api_base The API URL to query. The default value is "https://api.openai.com".
...
#' @return An object of class "ImagesResponse".
#' @export
create_image_edit <- function(endpoint = "images/edits",
                              image,
                              mask = NULL,
                              prompt,
                              n = 1,
...
#'
#' @param endpoint The API endpoint to use (default is \code{"images/variations"}).
...
#' @param api_base The URL of the API (default is NULL).
...
#' @return An object of class "ImagesResponse".
#' @export
create_image_variation <- function(endpoint = "images/variations ",
                                   image,
                                   n = 1,
                                   size = c("1024x1024", "512x512", "256x256"),
                                   response_format = c("url", "b64_json"),
