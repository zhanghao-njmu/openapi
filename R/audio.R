...
#'
#' @param endpoint an endpoint url (default "audio/transcriptions").
...
#' @param api_base base URL for the OpenAI API (default NULL).
...
#'
#' @export
create_transcription <- function(endpoint = "audio/transcriptions",
                                 file,
                                 model = "whisper-1",
                                 prompt = NULL,
...
#'
#' @param endpoint A string indicating the API endpoint for making requests (default is "audio/translations").
...
#' @param api_base A string indicating the base URL of the OpenAI API (default is NULL).
...
#' @return An object of class "AudioResponse".
#' @export
create_translation <- function(endpoint = "audio/translations",
                               file,
                               model = "whisper-1",
                               prompt = NULL,
                               response_format = c("json", "text", "srt", "verbose_json", "vtt"),
