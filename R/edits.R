...
#'
#' @param endpoint A character string indicating the endpoint for the OpenAI API. Default is "v1/edits".
...
#' @param api_url A character string representing the URL for the OpenAI API. Default is NULL.
